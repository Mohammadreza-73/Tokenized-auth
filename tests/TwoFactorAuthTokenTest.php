...
class TwoFactorAuthTokenTest extends TestCase
{
    public function test_the_happy_path()
    {
        ...
        $this->post('/api/tokenized-login/request-token?email=foo@bar.com');
    }
    ...
    public function test_user_is_banned()
    {
        ...
        $response = $this->post('/api/tokenized-login/request-token?email=foo@bar.com');
    ...
    public function test_email_not_valid()
    {
        ...
        $response = $this->post('/api/tokenized-login/request-token?email=foo_bar.com');
        $response->assertSee('hello');
    }
